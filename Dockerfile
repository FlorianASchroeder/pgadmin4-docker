...
ENV PGADMIN_VERSION=7.4
ENV PYTHONDONTWRITEBYTECODE=1

RUN pip install --upgrade --no-cache-dir pip \
 && echo "https://ftp.postgresql.org/pub/pgadmin/pgadmin4/v${PGADMIN_VERSION}/pip/pgadmin4-7.4-py3-none-any.whl" | pip install --no-cache-dir -r /dev/stdin \
