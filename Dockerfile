...
ENV PGADMIN_VERSION=8.6
ENV PYTHONDONTWRITEBYTECODE=1

RUN pip install --upgrade --no-cache-dir pip \
 && echo "https://ftp.postgresql.org/pub/pgadmin/pgadmin4/v${PGADMIN_VERSION}/pip/pgadmin4-8.6-py3-none-any.whl" | pip install --no-cache-dir -r /dev/stdin \
